...
class registroUsuarioForm(UserCreationForm):
    ...
    email= forms.EmailField(widget=forms.TextInput(attrs={"class":"form-control", "placeholder":" Ingrese su email: ","class":"form-control"}),
            help_text=(".........")) #ver bien
    contraseña= forms.CharField(label="Ingrese una contraseña: ",
    ...
    contraseña2= forms.CharField(label="Confirme su contraseña: ", 
    ...
    class Meta:
        model = User
        fields = ["username", "email", "contraseña", "contraseña2"]
